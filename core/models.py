...
class OpenSpace(models.Model):
    ...
    perimeter = models.FloatField(default=Decimal('0.0000'), null=True, blank=True)
    ...
    usable_2013 = models.FloatField(default=Decimal('0.0000'), null=True, blank=True)
    area_change = models.FloatField(default=Decimal('0.0000'), null=True, blank=True)
